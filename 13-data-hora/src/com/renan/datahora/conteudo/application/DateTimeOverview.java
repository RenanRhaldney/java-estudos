...
public class DateTimeOverview {
	...
	public static void main(String[] args) {
		...
		System.out.println("Formato brasileiro: " + data.format(formatoBrasileiro));

		System.out.println("Formato completo: " + dataHora.format(formatoCompleto));
		...
		System.out.println("Último dia: " + data.withDayOfMonth(data.lengthOfMonth()));
		...
		LocalDateTime horarioBrasil = LocalDateTime.ofInstant(instanteUtc, brasil);
		...
		LocalDateTime dataHoraCompleta = LocalDateTime.of(data, LocalTime.of(15, 45));
		...
		// INPUT DE DATA PELO CONSOLE

		// ==========================================================

		titulo("23. INPUT DE DATA PELO CONSOLE");
		...
		LocalDate datainput = LocalDate.parse(entrada, formato);

		System.out.println("Data informada: " + datainput);
